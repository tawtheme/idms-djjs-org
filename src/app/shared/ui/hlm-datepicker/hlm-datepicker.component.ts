...
@Component({
  ...
  templateUrl: './hlm-datepicker.component.html',
  styleUrls: ['./hlm-datepicker.component.scss']
})
export class HlmDatepickerComponent implements OnInit, OnChanges, AfterViewInit {
